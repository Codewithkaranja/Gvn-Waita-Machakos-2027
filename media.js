// Navbar scroll effect
        ...
        function downloadFile(fileType) {
            ...
            switch(fileType) {
                case 'manifesto':
                    fileName = 'Nzioka_Waita_Campaign_Manifesto_2027.pdf';
                    fileSize = '2.4MB';
                    break;
                case 'speech':
                    ...
                    break;
                case 'policy':
                    fileName = 'Economic_Policy_Brief_Machakos_2027.pdf';
                    fileSize = '3.2MB';
                    break;
            }
        ...
        document.querySelector('a[href="#donate"]').addEventListener('click', function(e) {
            ...
            modal.innerHTML = `
                <div style="background: white; padding: 40px; border-radius: 10px; max-width: 500px; width: 90%; position: relative;">
                    ...
                    <p style="color: var(--gray); margin-bottom: 20px;">Your donation helps us reach more voters and build a better Machakos. Choose your donation method:</p>
                    ...
                    <div style="margin-bottom: 25px;">
                        ...
                        <div style="background: #f3f4f6; padding: 15px; border-radius: 5px; margin-bottom: 15px;">
                            ...
                            <p style="margin-bottom: 10px;"><strong>Account Number:</strong> NZIOKAWAITA</p>
                        </div>
                    </div>
                    ...
                    <div style="margin-bottom: 30px;">
                        ...
                        <div style="background: #f3f4f6; padding: 15px; border-radius: 5px;">
                            ...
                            <p style="margin-bottom: 10px;"><strong>Account Name:</strong> Nzioka Waita Campaign</p>
                            <p style="margin-bottom: 10px;"><strong>Account Number:</strong> 0123456789</p>
                            <p><strong>Branch:</strong> Machakos Central</p>
                        </div>
                    </div>
