            ...
            button.addEventListener('click', function(e) {
                ...
                modal.innerHTML = `
                    <div style="background: white; padding: 50px; border-radius: 15px; max-width: 550px; width: 100%; position: relative; box-shadow: 0 20px 60px rgba(0, 0, 0, 0.3);">
                        ...
                        <p style="color: var(--gray); margin-bottom: 25px; text-align: center; font-size: 1.1rem; line-height: 1.6;">Your contribution helps us reach more voters, organize events, and build a better Machakos. Every shilling makes a difference.</p>
                        ...
                        <div style="margin-bottom: 30px;">
                            ...
                            <div style="background: #f8fafc; padding: 20px; border-radius: 10px; margin-bottom: 20px; border-left: 4px solid var(--emerald);">
                                ...
                                <p style="margin-bottom: 12px; font-weight: 600;">Account Number: <span style="color: var(--emerald); font-size: 1.2rem;">NZIOKAWAITA</span></p>
                        ...
                        <div style="margin-bottom: 35px;">
                            ...
                            <div style="background: #f8fafc; padding: 20px; border-radius: 10px; border-left: 4px solid var(--gold);">
                                ...
                                <p style="margin-bottom: 10px;"><strong>Account Name:</strong> Nzioka Waita Campaign Fund</p>
                                <p style="margin-bottom: 10px;"><strong>Account Number:</strong> 0760 1234 5678</p>
                                <p style="margin-bottom: 10px;"><strong>Branch:</strong> Machakos Town</p>
